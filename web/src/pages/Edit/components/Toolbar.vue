<template>
  <div class="toolbarContainer" :class="{ isDark: isDark }">
    <div class="toolbar" ref="toolbarRef">
      ...
      <!-- 导出 -->
      <div class="toolbarBlock">
        <div class="toolbarBtn" @click="openDirectory" v-if="!isMobile && !takeOverApp">
        ...
        <div class="toolbarBtn" @click="saveLocalFile" v-if="!isMobile && !takeOverApp">
...
export default {
  ...
  data() {
    return {
      isMobile: isMobile(),
      takeOverApp: !!window.takeOverApp,
      horizontalList: [],
      verticalList: [],
      showMoreBtn: true,
      popoverShow: false,
